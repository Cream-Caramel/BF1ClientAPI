...
public static class WeaponDB
{
    ...
    public readonly static List<WeaponInfo> AllWeaponInfo = new()
    {
        ...
        // 突击兵 主要武器
        new() { Guid="16D7C222-5ACA-4728-854D-6282E44846DC", Kind="突击兵 主要武器", Id="U_RemingtonM10_Wep_Slug", Name="Model 10-A（霰弹块）", Kick="10A XDK", Image="RemingtonM10-08ab3f5b.png" },
        new() { Guid="508E534A-A7A5-41A1-8F8F-FEDFA0AFDA93", Kind="突击兵 主要武器", Id="U_RemingtonM10_Wep_Choke", Name="Model 10-A（猎人）", Kick="10A LR", Image="RemingtonM10-08ab3f5b.png" },
        new() { Guid="ED262207-65C8-46E1-B5D4-D7468143790F", Kind="突击兵 主要武器", Id="U_RemingtonM10", Name="Model 10-A（原厂）", Kick="10A YC", Image="RemingtonM10-08ab3f5b.png" },
        new() { Guid="9F97B37E-2A81-4AE3-A96A-4402B30BF184", Kind="突击兵 主要武器", Id="U_Winchester1897_Wep_Sweeper", Name="M97 战壕枪（扫荡）", Kick="M97 SD", Image="WinchesterM1897-bb453195.png" },
        new() { Guid="EA7C6CF1-5801-4C52-8685-51B4C7B90CE9", Kind="突击兵 主要武器", Id="U_Winchester1897_Wep_LowRecoil", Name="M97 战壕枪（Back-Bored）", Kick="M97 BB", Image="WinchesterM1897-bb453195.png" },
        new() { Guid="20D21E3D-BA5F-4239-8F90-42FCDDA12F51", Kind="突击兵 主要武器", Id="U_Winchester1897_Wep_Choke", Name="M97 战壕枪（猎人）", Kick="M97 LR", Image="WinchesterM1897-bb453195.png" },
        new() { Guid="ADA8C89D-F213-401C-806C-B60483E2EEE7", Kind="突击兵 主要武器", Id="U_MP18_Wep_Trench", Name="MP 18（壕沟战）", Kick="MP18 HGZ", Image="BergmannSchmeisserMP18-761af430.png" },
        new() { Guid="A498D568-2F50-449C-BA5D-6864AB34F8D2", Kind="突击兵 主要武器", Id="U_MP18_Wep_Burst", Name="MP 18（实验）", Kick="MP18 SY", Image="BergmannSchmeisserMP18-761af430.png" },
        new() { Guid="765A6856-3A80-4196-8DB6-14A95B94AB85", Kind="突击兵 主要武器", Id="U_MP18_Wep_Accuracy", Name="MP 18（瞄准镜）", Kick="MP18 MZJ", Image="BergmannSchmeisserMP18-761af430.png" },
        new() { Guid="58E00507-4123-49D9-A9DE-0F5C7A267CC4", Kind="突击兵 主要武器", Id="U_BerettaM1918_Wep_Trench", Name="M1918 自动冲锋枪（壕沟战）", Kick="MP1918 HGZ", Image="Beretta1918-3daab991.png" },
        new() { Guid="29539D1A-A492-4398-BABF-6BC8DBD4BECA", Kind="突击兵 主要武器", Id="U_BerettaM1918_Wep_Stability", Name="M1918 自动冲锋枪（冲锋）", Kick="MP1918 CF", Image="Beretta1918-3daab991.png" },
        new() { Guid="2439B810-3ACD-4069-B1E9-0CDC2CE51985", Kind="突击兵 主要武器", Id="U_BerettaM1918", Name="M1918 自动冲锋枪（原厂）", Kick="MP1918 YC", Image="Beretta1918-3daab991.png" },
        new() { Guid="FA78AFDF-D06D-4CBE-B325-945F9B4091C3", Kind="突击兵 主要武器", Id="U_BrowningA5_Wep_LowRecoil", Name="12g 自动霰弹枪（Back-Bored）", Kick="12g BB", Image="BrowingA5-95b260b4.png" },
        new() { Guid="31D6D032-5B6F-4494-A04A-0FB8EDB130BB", Kind="突击兵 主要武器", Id="U_BrowningA5_Wep_Choke", Name="12g 自动霰弹枪（猎人）", Kick="12g LR", Image="BrowingA5-95b260b4.png" },
        new() { Guid="D7A0DED9-EC54-4523-9294-656FA1881FE9", Kind="突击兵 主要武器", Id="U_BrowningA5_Wep_ExtensionTube", Name="12g 自动霰弹枪（加长）", Kick="12g JC", Image="BrowingA5-95b260b4.png" },
        new() { Guid="2B253855-7BA0-4FF6-9F25-57D53B15FE32", Kind="突击兵 主要武器", Id="U_Hellriegel1915", Name="Hellriegel 1915（原厂）", Kick="H1915 YC", Image="Hellriegel1915-e2513c1e.png" },
        new() { Guid="B1E5A3BC-3D24-4FE5-84D1-4523D6DCE545", Kind="突击兵 主要武器", Id="U_Hellriegel1915_Wep_Accuracy", Name="Hellriegel 1915（防御）", Kick="H1915 FY", Image="Hellriegel1915-e2513c1e.png" },
        new() { Guid="8F241031-A76D-436B-AE5F-CD797B504A7A", Kind="突击兵 主要武器", Id="U_Winchester1897_Wep_Preorder", Name="地狱战士战壕霰弹枪", Kick="M97 DYZS", Image="WinchesterM1897-bb453195.png" },
        new() { Guid="5D89166E-58E1-46FD-B854-69641E9DCEF7", Kind="突击兵 主要武器", Id="U_SjogrenShotgun", Name="Sj?gren Inertial（原厂）", Kick="RDP YC", Image="SjogrenShotgun-e95b3db0.png" },
        new() { Guid="42B442BF-6ACE-4592-A53B-96424B4ACABF", Kind="突击兵 主要武器", Id="U_SjogrenShotgun_Wep_Slug", Name="Sj?gren Inertial（霰弹块）", Kick="RDP XDK", Image="SjogrenShotgun-e95b3db0.png" },
        new() { Guid="6B07DE60-5568-43C0-B1F6-D51A13A9BD3C", Kind="突击兵 主要武器", Id="U_Ribeyrolles", Name="利贝罗勒 1918（原厂）", Kick="L1918 YC", Image="Ribeyrolles-0e43197c.png" },
        new() { Guid="C4B84F0E-D7FF-49D9-9796-E6CF95C058BD", Kind="突击兵 主要武器", Id="U_Ribeyrolles_Wep_Optical", Name="Ribeyrolles 1918（瞄准镜）", Kick="L1918 MZJ", Image="Ribeyrolles-0e43197c.png" },
        new() { Guid="CCA1F8F7-5658-4DCA-BAA8-2C930C2EF5F0", Kind="突击兵 主要武器", Id="U_RemingtonModel1900", Name="Model 1900（原厂）", Kick="M1900 YC", Image="RemingtonModel1900-e80b885b.png" },
        new() { Guid="55381B1D-7E17-44BE-AC0B-33542A64BF96", Kind="突击兵 主要武器", Id="U_RemingtonModel1900_Wep_Slug", Name="Model 1900（霰弹块）", Kick="M1900 XDK", Image="RemingtonModel1900-e80b885b.png" },
        new() { Guid="C4F8BC18-1908-4A83-ABB6-B812C05D49CE", Kind="突击兵 主要武器", Id="U_MaximSMG", Name="SMG 08/18（原厂）", Kick="SMG0818 YC", Image="MaximSMG-c3563db7.png" },
        new() { Guid="DEC97287-AF0B-49E4-8FD8-CBC5FB5AF497", Kind="突击兵 主要武器", Id="U_MaximSMG_Wep_Accuracy", Name="SMG 08/18（瞄准镜）", Kick="SMG0818 MZJ", Image="MaximSMG-c3563db7.png" },
        new() { Guid="E1297C9B-861A-4170-840B-83AC64A0C574", Kind="突击兵 主要武器", Id="U_SteyrM1912_P16", Name="M1912/P.16（冲锋）", Kick="M1912 P.16 CF", Image="SteyrM1912Stock-a1ad884f.png" },
        new() { Guid="39137F1F-B794-4265-BB30-490E1E182F81", Kind="突击兵 主要武器", Id="U_SteyrM1912_P16_Wep_Burst", Name="Maschinenpistole M1912/P.16（实验）", Kick="M1912 P.16 SY", Image="SteyrM1912Stock-a1ad884f.png" },
        new() { Guid="1C5B531F-26B4-429F-839B-99252610A7F0", Kind="突击兵 主要武器", Id="U_Mauser1917Trench", Name="M1917 战壕卡宾枪", Kick="M1917 KBQ ZH", Image="MauserM1917TrenchCarbine-9a4158a1.png" },
        new() { Guid="245A23B1-53BA-4AB2-A416-224794F15FCB", Kind="突击兵 主要武器", Id="U_Mauser1917Trench_Wep_Scope", Name="M1917 卡宾枪（巡逻）", Kick="M1917 KBQ XL", Image="MauserM1917TrenchCarbine-9a4158a1.png" },
        new() { Guid="6C3EE48B-0974-48B1-AFF7-96FD4D684E82", Kind="突击兵 主要武器", Id="U_ChauchatSMG", Name="RSC 冲锋枪（原厂）", Kick="RSC YC", Image="Chauchat-Ribeyrolles-4af8a912.png" },
        new() { Guid="6DAFDE21-2502-41B4-878B-532E70905238", Kind="突击兵 主要武器", Id="U_ChauchatSMG_Wep_Optical", Name="RSC 冲锋枪（瞄准镜）", Kick="RSC MZJ", Image="Chauchat-Ribeyrolles-4af8a912.png" },
        new() { Guid="C70FE9E0-0A1C-470C-B377-68059953EAD8", Kind="突击兵 主要武器", Id="U_M1919Thompson_Wep_Trench", Name="Annihilator（壕沟）", Kick="Annihilator HG", Image="ThompsonAnnihilatorTr-1a660e74.png" },
        new() { Guid="DBC25B43-29D9-4FB4-B9EF-C4966CD773B3", Kind="突击兵 主要武器", Id="U_M1919Thompson_Wep_Stability", Name="Annihilator（冲锋）", Kick="Annihilator CF", Image="ThompsonAnnihilatorTr-1a660e74.png" },
        new() { Guid="A9985C95-7364-4AE3-BC77-C53651128EBE", Kind="突击兵 主要武器", Id="U_M1919Thompson", Name="M1919 冲锋枪", Kick="M1919", Image="M1919Thompson-1cf7343d.png" },
        new() { Guid="D8AEB334-58E2-4A52-83BA-F3C2107196F0", Kind="突击兵 主要武器", Id="U_FrommerStopAuto", Name="费罗梅尔停止手枪（自动）", Kick="FrommerStopAuto", Image="FrommerStop-506df97e.png" },
        new() { Guid="7085A5B9-6A77-4766-83CD-3666DA3EDF28", Kind="突击兵 主要武器", Id="U_SawnOffShotgun", Name="短管霰弹枪", Kick="SawnOffShotgun", Image="SawedOfShotgun-d31e0dd8.png" },
